      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("admin/kategori_aksi_ubah/".$tbl_kategori->id_kategori); ?>
					<div class="col-md-4">
					  ...
					  <div class="form-group">
						...
						<a href="<?php echo base_url("admin/kategori");?>"><input type="button" value="Cancel" class="btn btn-danger"></a>
					  </div>
					</div>
					<?php echo form_close(); ?>
				  </div>
