      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("admin/dosen_aksi_tambah"); ?>
					<div class="col-md-4">
					  <div class="form-group">
						<label>ID Dosen</label>
						<input type="text" class="form-control" name="kodepeminjam_user" placeholder="ID Dosen" value="<?php echo $kodepeminjam_user;?>" required>
					  </div>
					  <div class="form-group">
