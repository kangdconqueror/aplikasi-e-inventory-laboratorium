		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					...
					?>
						<p style="color:red;"><i>ID Mahasiswa sudah digunakan, silahkan coba yang lain.</i></p>
					<?php 
					}else{
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("admin/mahasiswa_aksi_ubah/$tbl_user->id_user"); ?>
					<div class="col-md-4">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" name="nama_user" placeholder="Nama Peminjam" value="<?php echo $nama_user;?>" required>
					  </div>
					  <div class="form-group">
