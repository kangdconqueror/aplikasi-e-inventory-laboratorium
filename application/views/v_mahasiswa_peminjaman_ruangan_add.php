      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("mahasiswa/peminjamanruang_aksi_tambah/"); ?>
					<div class="col-md-6">
...
<script type="text/javascript">        
   function handler(e){
	  window.location.href = '<?php echo base_url()."mahasiswa/peminjamanruang_tambah/";?>'+ e.target.value +'<?php echo "/".$kode_ruangan; ?>';
	}
	
	function handlerewe(e){
	  window.location.href = '<?php echo base_url()."mahasiswa/peminjamanruang_tambah/".$date."/"; ?>'+ e.target.value;
	}
</script>
    </section>
  </div>