...
class Dosen extends CI_Controller {
	...
	public function index()
    {
        ...
        $this->load->view("v_dosen_index", $data);
	...
	public function profile()
    {
		...
		$data['err'] = "";
		$this->load->view("v_admin_header");
        $this->load->view("v_dosen_profile", $data);
        $this->load->view("v_admin_footer");
    }
    ...
    {
		$this->load->view("v_admin_header");
        $this->load->view("v_dosen_peminjaman_inventaris");
        $this->load->view("v_admin_footer");
    }		
	...
	public function peminjamaninv_tambah()
    {
		...
		$this->load->view("v_admin_header");
        $this->load->view("v_dosen_peminjaman_inventaris_add", $data);
        $this->load->view("v_admin_footer");
    }
	...
	public function peminjamaninv_ubah($id_peminjaman)
	{
		...
		$this->load->view("v_admin_header");
		$this->load->view('v_dosen_peminjaman_inventaris_edit', $data);
		$this->load->view("v_admin_footer");
	}	
    ...
    {
		$this->load->view("v_admin_header");
        $this->load->view("v_dosen_peminjaman_ruangan");
        $this->load->view("v_admin_footer");
    }
	...
	public function peminjamanruang_tambah()
    {
		...
		$this->load->view("v_admin_header");
        $this->load->view("v_dosen_peminjaman_ruangan_add", $data);
        $this->load->view("v_admin_footer");
    }		
	...
	public function peminjamanruang_ubah($id_peminjaman)
	{
		...
		$this->load->view("v_admin_header");
		$this->load->view('v_dosen_peminjaman_ruangan_edit', $data);
		$this->load->view("v_admin_footer");
	}	
	...
	public function peminjamanruang_aksi_tambah()
    {
			...
			$this->m_general->add("tbl_inbox", $inbox);
			redirect('dosen/peminjamanruang_tambah/'.$_POST['tanggal_peminjaman'].'/'.$_POST['kode_ruangan']);
    }
	public function peminjamanruang_aksi_ubah($id_peminjaman, $tanggal_peminjaman)
    {
			...
			redirect('dosen/peminjamanruang/'.$tanggal_peminjaman);
    }	
